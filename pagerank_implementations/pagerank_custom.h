...
float * pagerank_custom_in_ocl(int ** graph, int * in_degrees, int * out_degrees,
                ...
                double epsilon, double * start_global, double * end_global) {
    ...
    *start_global = omp_get_wtime();
    ...
    int kernel_leaked_pr_wi = 32, kernel_leaked_pr_wg = 1,
            kernel_norm_wg_wi = 64, kernel_norm_wg_wg = 1,
            kernel_norm_fin_wi = 32, kernel_norm_fin_wg = 1,
            kernel_pagerank_step_wi = 32, kernel_pagerank_step_wg = 1;
